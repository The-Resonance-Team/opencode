export const dict = {
  ...
  "ui.officePreview.commentSubmit": "Комментировать",
  "ui.officePreview.addComment": "Добавить комментарий",
  "ui.officePreview.suggested": "Предложение",
  "ui.officePreview.status.open": "Открыто",
  "ui.officePreview.status.resolved": "Решено",
  "ui.officePreview.status.denied": "Отклонено",
  "ui.officePreview.action.resolve": "Решить",
  "ui.officePreview.action.deny": "Отклонить",
  "ui.officePreview.action.approve": "Одобрить",
  "ui.officePreview.action.edit": "Изменить",
  "ui.officePreview.action.delete": "Удалить",
  "ui.officePreview.edit": "Изменить",
  "ui.officePreview.save": "Сохранить",
  "ui.officePreview.cancel": "Отмена",
  "ui.officePreview.accept": "Принять",
  "ui.officePreview.acceptTitle": "Принять этот документ?",
  "ui.officePreview.acceptDescription": "Черновик будет принят, а документ загружен заново из файла.",
  "ui.officePreview.openInApp": "Открыть в приложении",
  "ui.officePreview.download": "Скачать",
  "ui.officePreview.error": "Не удалось выполнить действие",
