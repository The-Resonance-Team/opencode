...
const main = Effect.gen(function* () {
  ...
  const appId = app.isPackaged ? APP_IDS[CHANNEL] : "ai.opencode-resonance.desktop.dev"
  ...
  app.setName(app.isPackaged ? APP_NAMES[CHANNEL] : "OpenCode Resonance Dev")
  ...
  app.on("second-instance", (_event: Event, argv: string[]) => {
    const urls = argv.filter((arg: string) => arg.startsWith("opencode-resonance://"))
    if (urls.length) {
  ...
  app.setAsDefaultProtocolClient("opencode-resonance")
  registerRendererProtocol()
  setDockIcon()
