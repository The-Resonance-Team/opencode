export const dict = {
  ...
  "titlebar.debugTools.toggle": "Attiva/disattiva strumenti di debug",
  ...
  "prompt.toast.attachmentTooLarge.title": "Questo file è più grande del limite di allegato di 10 MiB",
