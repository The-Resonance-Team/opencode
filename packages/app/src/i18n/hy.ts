export const dict = {
  ...
  "titlebar.debugTools.toggle": "Միացնել/անջատել կարգավորման գործիքները",
  ...
  "prompt.toast.attachmentTooLarge.title": "Այս ֆայլը գերազանցում է 10 MiB կից ֆայլի սահմանափակումը",
