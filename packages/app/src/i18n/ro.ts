export const dict = {
  ...
  "titlebar.debugTools.toggle": "Comută instrumentele de depanare",
  ...
  "prompt.toast.attachmentTooLarge.title": "Acest fișier este mai mare decât limita de atașament de 10 MiB",
