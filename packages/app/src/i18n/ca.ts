export const dict = {
  ...
  "titlebar.debugTools.toggle": "Commuta les eines de depuració",
  ...
  "prompt.toast.attachmentTooLarge.title": "Aquest fitxer és més gran que el límit de fitxers adjunts de 10 MiB",
