export const dict = {
  ...
  "titlebar.debugTools.toggle": "Alternar herramientas de depuración",
  ...
  "prompt.toast.attachmentTooLarge.title": "Este archivo es más grande que el límite de adjuntos de 10 MiB",
