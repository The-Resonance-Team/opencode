export const dict = {
  ...
  "titlebar.debugTools.toggle": "Preklopi orodja za odpravljanje napak",
  ...
  "prompt.toast.attachmentTooLarge.title": "Ta datoteka je večja od omejitve priponke 10 MiB",
