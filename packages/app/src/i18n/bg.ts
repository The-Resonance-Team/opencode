export const dict = {
  ...
  "titlebar.debugTools.toggle": "Превключване на инструменти за отстраняване на грешки",
  "common.cancel": "Отказ",
  "common.clear": "ясно",
  ...
  "prompt.toast.attachmentTooLarge.title": "Този файл е по-голям от ограничението за прикачени файлове от 10 MiB",
