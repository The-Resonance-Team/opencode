export const dict = {
  ...
  "titlebar.debugTools.toggle": "Промени алатки за отстранување грешки",
  ...
  "prompt.toast.attachmentTooLarge.title": "Оваа датотека е поголема од ограничувањето од 10 MiB",
